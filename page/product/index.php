                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a class="nav-link" href="index.php">Product</a></li>
                                <li><a class="nav-link" href="product.php">Product Settings</a></li>
                            </ul>
                                    ...
                                    <table class="table table-striped table-md">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="product.php?id_produk=<?php echo $row["id_produk"] ?>" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
