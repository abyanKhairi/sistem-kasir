...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `product`(`id_produk`, `nama_produk`, `jumlah_produk`, `harga_produk`) VALUES (NULL,'$nama_produk','$jumlah_produk','$harga_produk')";
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="index.php">Produk</a></li>
                                <li class="active"><a class="nav-link" href="#">Produk Settings</a></li>
                            </ul>
